...
function wphcu_init() {
	register_setting('hit-counter-ultimate-group', 'wphcu_exclude_ips',  'iplist');
    register_setting('hit-counter-ultimate-group', 'wphcu_display_footer', 'intval');
    register_setting('hit-counter-ultimate-group', 'wphcu_display_credit', 'intval');
    register_setting('hit-counter-ultimate-group', 'wphcu_style');
    register_setting('hit-counter-ultimate-group', 'wphcu_data', 'intval');
    register_setting('hit-counter-ultimate-group', 'wphcu_align');
    register_setting('hit-counter-ultimate-group', 'wphcu_count_only_unique', 'intval');}
...
function wphcu_menu() {
  add_options_page('Hit Counter Ultimate Options', 'Hit Counter Ultimate', 'administrator', 'hit-counter-ultimate', 'wphcu_options');
}
...
function wphcu_options() {
    ...
    <h2>Hit Counter Ultimate Settings</h2>

    <form method="post" action="options.php">
        <?php settings_fields( 'hit-counter-ultimate-group' ); ?>
        <?php
            $data = file_array(WP_CONTENT_DIR . '/plugins/hit-counter-ultimate/designs/');
    ...
    <?php
                foreach ($style as $name) {
                	...
                	<tr>
                		...
                		<img src='<?php echo WP_PLUGIN_URL?>/hit-counter-ultimate/designs/<?php echo $style_name . '/' . $name . '/'; ?>1.gif'>
                		<img src='<?php echo WP_PLUGIN_URL?>/hit-counter-ultimate/designs/<?php echo $style_name . '/' . $name . '/'; ?>2.gif'>
                		<img src='<?php echo WP_PLUGIN_URL?>/hit-counter-ultimate/designs/<?php echo $style_name . '/' . $name . '/'; ?>3.gif'>
                		</td>
                	</tr>
                    <?php
                }
